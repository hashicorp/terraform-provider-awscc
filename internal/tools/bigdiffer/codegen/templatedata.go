...
// represent. internal/provider/generators/derecurse-schema writes the key; pristine
// schemas lack it and yield nil. Mirrors the legacy generator so the two engines
// stay at parity on de-recursed schemas.
