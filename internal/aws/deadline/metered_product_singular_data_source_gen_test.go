...
func TestAccAWSDeadlineMeteredProductDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Deadline::MeteredProduct", "awscc_deadline_metered_product", "test")
...
func TestAccAWSDeadlineMeteredProductDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Deadline::MeteredProduct", "awscc_deadline_metered_product", "test")
