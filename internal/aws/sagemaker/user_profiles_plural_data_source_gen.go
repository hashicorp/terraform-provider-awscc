...
func userProfilesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::SageMaker::UserProfile", "awscc_sagemaker_user_profiles", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_sagemaker_user_profiles", "schema", hclog.Fmt("%v", schema))
