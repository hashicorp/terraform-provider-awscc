...
func init() {
	registry.AddResourceTypeFactory("aws_sagemaker_app_image_config", appImageConfigResourceType)
}

// appImageConfigResourceType returns the Terraform aws_sagemaker_app_image_config resource type.
