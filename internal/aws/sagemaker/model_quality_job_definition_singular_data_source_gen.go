...
func init() {
	registry.AddDataSourceTypeFactory("awscc_sagemaker_model_quality_job_definition", modelQualityJobDefinitionDataSourceType)
}

// modelQualityJobDefinitionDataSourceType returns the Terraform awscc_sagemaker_model_quality_job_definition data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::SageMaker::ModelQualityJobDefinition resource type.
func modelQualityJobDefinitionDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
