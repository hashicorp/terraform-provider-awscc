...
func init() {
	registry.AddResourceTypeFactory("aws_sagemaker_image", image)
}

// image returns the Terraform aws_sagemaker_image resource type.
// This Terraform resource type corresponds to the CloudFormation AWS::SageMaker::Image resource type.
func image(ctx context.Context) (tfsdk.ResourceType, error) {
