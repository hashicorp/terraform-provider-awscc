...
func init() {
	registry.AddDataSourceFactory("awscc_sagemaker_feature_groups", featureGroupsDataSource)
}

// featureGroupsDataSource returns the Terraform awscc_sagemaker_feature_groups data source.
// This Terraform data source corresponds to the CloudFormation AWS::SageMaker::FeatureGroup resource.
func featureGroupsDataSource(ctx context.Context) (datasource.DataSource, error) {
