...
func init() {
	registry.AddDataSourceTypeFactory("awscc_sagemaker_data_quality_job_definition", dataQualityJobDefinitionDataSourceType)
}

// dataQualityJobDefinitionDataSourceType returns the Terraform awscc_sagemaker_data_quality_job_definition data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::SageMaker::DataQualityJobDefinition resource type.
func dataQualityJobDefinitionDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
