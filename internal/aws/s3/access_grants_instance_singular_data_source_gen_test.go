...
func TestAccAWSS3AccessGrantsInstanceDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::S3::AccessGrantsInstance", "awscc_s3_access_grants_instance", "test")
...
func TestAccAWSS3AccessGrantsInstanceDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::S3::AccessGrantsInstance", "awscc_s3_access_grants_instance", "test")
