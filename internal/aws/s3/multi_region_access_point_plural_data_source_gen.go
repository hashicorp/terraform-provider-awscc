...
func init() {
	registry.AddDataSourceFactory("awscc_s3_multi_region_access_points", multiRegionAccessPointsDataSource)
}

// multiRegionAccessPointsDataSource returns the Terraform awscc_s3_multi_region_access_points data source.
// This Terraform data source corresponds to the CloudFormation AWS::S3::MultiRegionAccessPoint resource.
func multiRegionAccessPointsDataSource(ctx context.Context) (datasource.DataSource, error) {
