...
func init() {
	registry.AddDataSourceTypeFactory("awscc_cloudformation_resource_default_version", resourceDefaultVersionDataSourceType)
}

// resourceDefaultVersionDataSourceType returns the Terraform awscc_cloudformation_resource_default_version data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::CloudFormation::ResourceDefaultVersion resource type.
func resourceDefaultVersionDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
