...
// simulationApplicationVersionDataSource returns the Terraform awscc_robomaker_simulation_application_version data source.
// This Terraform data source corresponds to the CloudFormation AWS::RoboMaker::SimulationApplicationVersion resource.
func simulationApplicationVersionDataSource(ctx context.Context) (datasource.DataSource, error) {
