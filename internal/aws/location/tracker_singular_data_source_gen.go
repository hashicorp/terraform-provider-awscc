...
func init() {
	registry.AddDataSourceTypeFactory("awscc_location_tracker", trackerDataSourceType)
}

// trackerDataSourceType returns the Terraform awscc_location_tracker data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::Location::Tracker resource type.
func trackerDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
