...
func init() {
	registry.AddDataSourceFactory("awscc_location_route_calculators", routeCalculatorsDataSource)
}

// routeCalculatorsDataSource returns the Terraform awscc_location_route_calculators data source.
// This Terraform data source corresponds to the CloudFormation AWS::Location::RouteCalculator resource.
func routeCalculatorsDataSource(ctx context.Context) (datasource.DataSource, error) {
