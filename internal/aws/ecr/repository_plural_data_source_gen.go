...
func init() {
	registry.AddDataSourceFactory("awscc_ecr_repositories", repositoriesDataSource)
}

// repositoriesDataSource returns the Terraform awscc_ecr_repositories data source.
