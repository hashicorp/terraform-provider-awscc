...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ecr_repositories", repositoriesDataSourceType)
}
...
func repositoriesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ecr_repositories", "schema", hclog.Fmt("%v", schema))
