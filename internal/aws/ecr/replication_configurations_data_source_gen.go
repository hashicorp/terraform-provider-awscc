...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ecr_replication_configurations", replicationConfigurationsDataSourceType)
}
...
func replicationConfigurationsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ecr_replication_configurations", "schema", hclog.Fmt("%v", schema))
