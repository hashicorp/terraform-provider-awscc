...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iotsitewise_dashboard", dashboardDataSourceType)
}

// dashboardDataSourceType returns the Terraform awscc_iotsitewise_dashboard data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::IoTSiteWise::Dashboard resource type.
