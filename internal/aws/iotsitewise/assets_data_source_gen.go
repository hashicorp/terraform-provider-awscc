...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iotsitewise_assets", assetsDataSourceType)
}
...
func assetsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_iotsitewise_assets", "schema", hclog.Fmt("%v", schema))
