...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iotsitewise_asset_model", assetModelDataSourceType)
}

// assetModelDataSourceType returns the Terraform awscc_iotsitewise_asset_model data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::IoTSiteWise::AssetModel resource type.
func assetModelDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
