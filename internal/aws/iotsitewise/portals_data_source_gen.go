...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iotsitewise_portals", portalsDataSourceType)
}
...
func portalsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_iotsitewise_portals", "schema", hclog.Fmt("%v", schema))
