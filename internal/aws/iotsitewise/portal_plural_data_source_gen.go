...
func init() {
	registry.AddDataSourceFactory("awscc_iotsitewise_portals", portalsDataSource)
}

// portalsDataSource returns the Terraform awscc_iotsitewise_portals data source.
