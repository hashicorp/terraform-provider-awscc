...
func TestAccAWSRoute53DelegationSetDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Route53::DelegationSet", "awscc_route53_delegation_set", "test")
...
func TestAccAWSRoute53DelegationSetDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Route53::DelegationSet", "awscc_route53_delegation_set", "test")
