...
func TestAccAWSIVSChatRoomDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IVSChat::Room", "awscc_ivschat_room", "test")
...
func TestAccAWSIVSChatRoomDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IVSChat::Room", "awscc_ivschat_room", "test")
