...
func studiosDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::NimbleStudio::Studio", "awscc_nimblestudio_studios", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_nimblestudio_studios", "schema", hclog.Fmt("%v", schema))
