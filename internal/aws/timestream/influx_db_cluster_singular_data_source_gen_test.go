...
func TestAccAWSTimestreamInfluxDBClusterDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Timestream::InfluxDBCluster", "awscc_timestream_influx_db_cluster", "test")
...
func TestAccAWSTimestreamInfluxDBClusterDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Timestream::InfluxDBCluster", "awscc_timestream_influx_db_cluster", "test")
