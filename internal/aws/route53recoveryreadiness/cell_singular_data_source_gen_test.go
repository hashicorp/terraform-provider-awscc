...
func TestAccAWSRoute53RecoveryReadinessCellDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Route53RecoveryReadiness::Cell", "awscc_route53recoveryreadiness_cell", "test")
...
func TestAccAWSRoute53RecoveryReadinessCellDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Route53RecoveryReadiness::Cell", "awscc_route53recoveryreadiness_cell", "test")
