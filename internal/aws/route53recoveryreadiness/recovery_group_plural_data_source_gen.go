...
func init() {
	registry.AddDataSourceFactory("awscc_route53recoveryreadiness_recovery_groups", recoveryGroupsDataSource)
}

// recoveryGroupsDataSource returns the Terraform awscc_route53recoveryreadiness_recovery_groups data source.
// This Terraform data source corresponds to the CloudFormation AWS::Route53RecoveryReadiness::RecoveryGroup resource.
func recoveryGroupsDataSource(ctx context.Context) (datasource.DataSource, error) {
