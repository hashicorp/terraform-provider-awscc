...
func cellsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::Route53RecoveryReadiness::Cell", "awscc_route53recoveryreadiness_cells", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_route53recoveryreadiness_cells", "schema", hclog.Fmt("%v", schema))
