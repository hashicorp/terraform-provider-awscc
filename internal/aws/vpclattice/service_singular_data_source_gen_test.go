...
func TestAccAWSVpcLatticeServiceDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::VpcLattice::Service", "awscc_vpclattice_service", "test")
...
func TestAccAWSVpcLatticeServiceDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::VpcLattice::Service", "awscc_vpclattice_service", "test")
