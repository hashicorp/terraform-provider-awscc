...
func init() {
	registry.AddDataSourceTypeFactory("awscc_fis_experiment_templates", experimentTemplatesDataSourceType)
}
...
func experimentTemplatesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_fis_experiment_templates", "schema", hclog.Fmt("%v", schema))
