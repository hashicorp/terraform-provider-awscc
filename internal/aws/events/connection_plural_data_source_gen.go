...
func init() {
	registry.AddDataSourceFactory("awscc_events_connections", connectionsDataSource)
}

// connectionsDataSource returns the Terraform awscc_events_connections data source.
