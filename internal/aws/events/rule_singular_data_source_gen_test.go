...
func TestAccAWSEventsRuleDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Events::Rule", "awscc_events_rule", "test")
...
func TestAccAWSEventsRuleDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Events::Rule", "awscc_events_rule", "test")
