...
func init() {
	registry.AddDataSourceFactory("awscc_batch_job_queues", jobQueuesDataSource)
}

// jobQueuesDataSource returns the Terraform awscc_batch_job_queues data source.
// This Terraform data source corresponds to the CloudFormation AWS::Batch::JobQueue resource.
func jobQueuesDataSource(ctx context.Context) (datasource.DataSource, error) {
