...
func init() {
	registry.AddDataSourceFactory("awscc_medialive_clusters", clustersDataSource)
}

// clustersDataSource returns the Terraform awscc_medialive_clusters data source.
...
func clustersDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::MediaLive::Cluster").WithTerraformTypeName("awscc_medialive_clusters")
