...
// eventBridgeRuleTemplateGroupDataSource returns the Terraform awscc_medialive_event_bridge_rule_template_group data source.
// This Terraform data source corresponds to the CloudFormation AWS::MediaLive::EventBridgeRuleTemplateGroup resource.
func eventBridgeRuleTemplateGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
