...
func init() {
	registry.AddDataSourceFactory("awscc_licensemanager_licenses", licensesDataSource)
}

// licensesDataSource returns the Terraform awscc_licensemanager_licenses data source.
// This Terraform data source corresponds to the CloudFormation AWS::LicenseManager::License resource.
func licensesDataSource(ctx context.Context) (datasource.DataSource, error) {
