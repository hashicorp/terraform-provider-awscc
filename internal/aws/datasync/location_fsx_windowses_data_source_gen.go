...
func locationFSxWindowsesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::DataSync::LocationFSxWindows", "awscc_datasync_location_fsx_windowses", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_datasync_location_fsx_windowses", "schema", hclog.Fmt("%v", schema))
