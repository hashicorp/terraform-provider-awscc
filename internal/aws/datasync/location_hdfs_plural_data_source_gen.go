...
func init() {
	registry.AddDataSourceFactory("awscc_datasync_location_hdfs_plural", locationHDFSPluralDataSource)
}

// locationHDFSPluralDataSource returns the Terraform awscc_datasync_location_hdfs_plural data source.
// This Terraform data source corresponds to the CloudFormation AWS::DataSync::LocationHDFS resource.
func locationHDFSPluralDataSource(ctx context.Context) (datasource.DataSource, error) {
