...
func locationObjectStoragesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::DataSync::LocationObjectStorage", "awscc_datasync_location_object_storages", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_datasync_location_object_storages", "schema", hclog.Fmt("%v", schema))
