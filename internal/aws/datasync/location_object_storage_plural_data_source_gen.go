...
func init() {
	registry.AddDataSourceFactory("awscc_datasync_location_object_storages", locationObjectStoragesDataSource)
}

// locationObjectStoragesDataSource returns the Terraform awscc_datasync_location_object_storages data source.
// This Terraform data source corresponds to the CloudFormation AWS::DataSync::LocationObjectStorage resource.
func locationObjectStoragesDataSource(ctx context.Context) (datasource.DataSource, error) {
