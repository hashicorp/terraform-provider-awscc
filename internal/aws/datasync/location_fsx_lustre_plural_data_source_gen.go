...
func init() {
	registry.AddDataSourceFactory("awscc_datasync_location_fsx_lustres", locationFSxLustresDataSource)
}

// locationFSxLustresDataSource returns the Terraform awscc_datasync_location_fsx_lustres data source.
// This Terraform data source corresponds to the CloudFormation AWS::DataSync::LocationFSxLustre resource.
func locationFSxLustresDataSource(ctx context.Context) (datasource.DataSource, error) {
