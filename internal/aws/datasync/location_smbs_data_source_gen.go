...
func init() {
	registry.AddDataSourceTypeFactory("awscc_datasync_location_smbs", locationSMBSDataSourceType)
}
...
func locationSMBSDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_datasync_location_smbs", "schema", hclog.Fmt("%v", schema))
