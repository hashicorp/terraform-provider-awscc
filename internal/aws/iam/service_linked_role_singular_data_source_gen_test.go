...
func TestAccAWSIAMServiceLinkedRoleDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IAM::ServiceLinkedRole", "awscc_iam_service_linked_role", "test")
...
func TestAccAWSIAMServiceLinkedRoleDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IAM::ServiceLinkedRole", "awscc_iam_service_linked_role", "test")
