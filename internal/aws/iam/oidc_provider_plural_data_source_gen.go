...
func init() {
	registry.AddDataSourceFactory("awscc_iam_oidc_providers", oIDCProvidersDataSource)
}

// oIDCProvidersDataSource returns the Terraform awscc_iam_oidc_providers data source.
