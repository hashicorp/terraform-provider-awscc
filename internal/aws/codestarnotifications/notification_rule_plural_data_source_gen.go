...
func init() {
	registry.AddDataSourceTypeFactory("awscc_codestarnotifications_notification_rules", notificationRulesDataSourceType)
}

// notificationRulesDataSourceType returns the Terraform awscc_codestarnotifications_notification_rules data source type.
...
func notificationRulesDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
