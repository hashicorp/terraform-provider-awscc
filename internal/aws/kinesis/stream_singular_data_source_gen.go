...
func init() {
	registry.AddDataSourceTypeFactory("awscc_kinesis_stream", streamDataSourceType)
}

// streamDataSourceType returns the Terraform awscc_kinesis_stream data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::Kinesis::Stream resource type.
func streamDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
