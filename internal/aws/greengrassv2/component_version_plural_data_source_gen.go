...
func init() {
	registry.AddDataSourceFactory("awscc_greengrassv2_component_versions", componentVersionsDataSource)
}

// componentVersionsDataSource returns the Terraform awscc_greengrassv2_component_versions data source.
// This Terraform data source corresponds to the CloudFormation AWS::GreengrassV2::ComponentVersion resource.
func componentVersionsDataSource(ctx context.Context) (datasource.DataSource, error) {
