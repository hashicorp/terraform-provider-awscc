...
func init() {
	registry.AddDataSourceTypeFactory("awscc_greengrassv2_component_versions", componentVersionsDataSourceType)
}
...
func componentVersionsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_greengrassv2_component_versions", "schema", hclog.Fmt("%v", schema))
