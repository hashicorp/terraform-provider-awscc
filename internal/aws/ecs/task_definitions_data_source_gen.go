...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ecs_task_definitions", taskDefinitionsDataSourceType)
}
...
func taskDefinitionsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ecs_task_definitions", "schema", hclog.Fmt("%v", schema))
