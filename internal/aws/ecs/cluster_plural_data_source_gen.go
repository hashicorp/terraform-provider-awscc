...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ecs_clusters", clustersDataSourceType)
}
...
func clustersDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ecs_clusters", "schema", hclog.Fmt("%v", schema))
