...
func init() {
	registry.AddDataSourceFactory("awscc_macie_allow_lists", allowListsDataSource)
}

// allowListsDataSource returns the Terraform awscc_macie_allow_lists data source.
...
func allowListsDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::Macie::AllowList").WithTerraformTypeName("awscc_macie_allow_lists")
