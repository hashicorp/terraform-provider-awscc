...
func TestAccAWSBedrockSessionDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Bedrock::Session", "awscc_bedrock_session", "test")
...
func TestAccAWSBedrockSessionDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Bedrock::Session", "awscc_bedrock_session", "test")
