...
func TestAccAWSODBCloudVmClusterDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::ODB::CloudVmCluster", "awscc_odb_cloud_vm_cluster", "test")
...
func TestAccAWSODBCloudVmClusterDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::ODB::CloudVmCluster", "awscc_odb_cloud_vm_cluster", "test")
