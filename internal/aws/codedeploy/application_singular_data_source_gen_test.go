...
func TestAccAWSCodeDeployApplicationDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::CodeDeploy::Application", "awscc_codedeploy_application", "test")
...
func TestAccAWSCodeDeployApplicationDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::CodeDeploy::Application", "awscc_codedeploy_application", "test")
