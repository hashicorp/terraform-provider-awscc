...
func init() {
	registry.AddDataSourceTypeFactory("awscc_lookoutvision_projects", projectsDataSourceType)
}
...
func projectsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_lookoutvision_projects", "schema", hclog.Fmt("%v", schema))
