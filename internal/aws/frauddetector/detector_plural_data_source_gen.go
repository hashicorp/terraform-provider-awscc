...
func init() {
	registry.AddDataSourceTypeFactory("awscc_frauddetector_detectors", detectorsDataSourceType)
}
...
func detectorsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_frauddetector_detectors", "schema", hclog.Fmt("%v", schema))
