...
func init() {
	registry.AddDataSourceTypeFactory("awscc_frauddetector_outcome", outcomeDataSourceType)
}

// outcomeDataSourceType returns the Terraform awscc_frauddetector_outcome data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::FraudDetector::Outcome resource type.
func outcomeDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
