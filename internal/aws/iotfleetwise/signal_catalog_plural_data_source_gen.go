...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iotfleetwise_signal_catalogs", signalCatalogsDataSourceType)
}

// signalCatalogsDataSourceType returns the Terraform awscc_iotfleetwise_signal_catalogs data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::IoTFleetWise::SignalCatalog resource type.
func signalCatalogsDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
