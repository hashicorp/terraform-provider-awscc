...
func init() {
	registry.AddResourceTypeFactory("awscc_iotfleetwise_vehicle", vehicleResourceType)
}

// vehicleResourceType returns the Terraform awscc_iotfleetwise_vehicle resource type.
// This Terraform resource type corresponds to the CloudFormation AWS::IoTFleetWise::Vehicle resource type.
func vehicleResourceType(ctx context.Context) (provider.ResourceType, error) {
