...
func init() {
	registry.AddResourceTypeFactory("awscc_iotfleetwise_fleet", fleetResourceType)
}

// fleetResourceType returns the Terraform awscc_iotfleetwise_fleet resource type.
// This Terraform resource type corresponds to the CloudFormation AWS::IoTFleetWise::Fleet resource type.
