...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iotfleetwise_campaign", campaignDataSourceType)
}

// campaignDataSourceType returns the Terraform awscc_iotfleetwise_campaign data source type.
