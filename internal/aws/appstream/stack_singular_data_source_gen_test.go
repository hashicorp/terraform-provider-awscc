...
func TestAccAWSAppStreamStackDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::AppStream::Stack", "awscc_appstream_stack", "test")
...
func TestAccAWSAppStreamStackDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::AppStream::Stack", "awscc_appstream_stack", "test")
