...
func init() {
	registry.AddDataSourceTypeFactory("awscc_networkfirewall_firewalls", firewallsDataSourceType)
}
...
func firewallsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_networkfirewall_firewalls", "schema", hclog.Fmt("%v", schema))
