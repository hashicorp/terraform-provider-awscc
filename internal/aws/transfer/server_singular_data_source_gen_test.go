...
func TestAccAWSTransferServerDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Transfer::Server", "awscc_transfer_server", "test")
...
func TestAccAWSTransferServerDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Transfer::Server", "awscc_transfer_server", "test")
