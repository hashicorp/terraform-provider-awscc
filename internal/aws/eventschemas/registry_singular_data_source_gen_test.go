...
func TestAccAWSEventSchemasRegistryDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EventSchemas::Registry", "awscc_eventschemas_registry", "test")
...
func TestAccAWSEventSchemasRegistryDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EventSchemas::Registry", "awscc_eventschemas_registry", "test")
