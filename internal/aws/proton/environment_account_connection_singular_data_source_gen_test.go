...
func TestAccAWSProtonEnvironmentAccountConnectionDataSource_basic(t *testing.T) {
...
func TestAccAWSProtonEnvironmentAccountConnectionDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Proton::EnvironmentAccountConnection", "awscc_proton_environment_account_connection", "test")
