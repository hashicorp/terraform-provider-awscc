...
func TestAccAWSRolesAnywhereProfileDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::RolesAnywhere::Profile", "awscc_rolesanywhere_profile", "test")
...
func TestAccAWSRolesAnywhereProfileDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::RolesAnywhere::Profile", "awscc_rolesanywhere_profile", "test")
