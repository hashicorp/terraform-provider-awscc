...
func init() {
	registry.AddDataSourceTypeFactory("awscc_elasticache_user_groups", userGroupsDataSourceType)
}
...
func userGroupsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_elasticache_user_groups", "schema", hclog.Fmt("%v", schema))
