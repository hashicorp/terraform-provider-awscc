...
// lifecyclePolicyDataSource returns the Terraform awscc_opensearchserverless_lifecycle_policy data source.
// This Terraform data source corresponds to the CloudFormation AWS::OpenSearchServerless::LifecyclePolicy resource.
