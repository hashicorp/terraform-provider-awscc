...
func init() {
	registry.AddDataSourceFactory("awscc_inspector_assessment_templates", assessmentTemplatesDataSource)
}

// assessmentTemplatesDataSource returns the Terraform awscc_inspector_assessment_templates data source.
// This Terraform data source corresponds to the CloudFormation AWS::Inspector::AssessmentTemplate resource.
func assessmentTemplatesDataSource(ctx context.Context) (datasource.DataSource, error) {
