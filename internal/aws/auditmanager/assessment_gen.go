...
func assessmentResourceType(ctx context.Context) (tfsdk.ResourceType, error) {
	attributes := map[string]tfsdk.Attribute{
			...
			Attributes: tfsdk.SingleNestedAttributes(
				map[string]tfsdk.Attribute{
					"email_address": {
						...
						Description: "The unique identifier for the email account.",
						Type:        types.StringType,
						Validators:  []tfsdk.AttributeValidator{validate.StringLenBetween(1, 320)},
						Optional:    true,
					},
					"id": {
						// Property: Id
			...
			Attributes: tfsdk.ListNestedAttributes(
				map[string]tfsdk.Attribute{
					...
					"control_set_id": {
						...
						Description: "The identifier for the specified control set.",
						Type:        types.StringType,
						Validators:  []tfsdk.AttributeValidator{validate.StringLenBetween(1, 300)},
						Optional:    true,
					},
					"created_by": {
						// Property: CreatedBy
		...
		"framework_id": {
			...
			Description: "The identifier for the specified framework.",
			Type:        types.StringType,
			Validators:  []tfsdk.AttributeValidator{validate.StringLenBetween(32, 36)},
			Optional:    true,
			Computed:    true,
