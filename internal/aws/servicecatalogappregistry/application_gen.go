...
func init() {
	registry.AddResourceTypeFactory("aws_servicecatalogappregistry_application", applicationResourceType)
}

// applicationResourceType returns the Terraform aws_servicecatalogappregistry_application resource type.
