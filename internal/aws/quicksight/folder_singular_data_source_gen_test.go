...
func TestAccAWSQuickSightFolderDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::QuickSight::Folder", "awscc_quicksight_folder", "test")
...
func TestAccAWSQuickSightFolderDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::QuickSight::Folder", "awscc_quicksight_folder", "test")
