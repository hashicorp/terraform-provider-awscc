...
func TestAccAWSQuickSightTopicV2DataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::QuickSight::TopicV2", "awscc_quicksight_topic_v2", "test")
...
func TestAccAWSQuickSightTopicV2DataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::QuickSight::TopicV2", "awscc_quicksight_topic_v2", "test")
