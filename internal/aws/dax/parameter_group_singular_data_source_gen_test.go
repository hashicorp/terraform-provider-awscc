...
func TestAccAWSDAXParameterGroupDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::DAX::ParameterGroup", "awscc_dax_parameter_group", "test")
...
func TestAccAWSDAXParameterGroupDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::DAX::ParameterGroup", "awscc_dax_parameter_group", "test")
