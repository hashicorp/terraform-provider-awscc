...
func TestAccAWSSDBDomainDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::SDB::Domain", "awscc_sdb_domain", "test")
...
func TestAccAWSSDBDomainDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::SDB::Domain", "awscc_sdb_domain", "test")
