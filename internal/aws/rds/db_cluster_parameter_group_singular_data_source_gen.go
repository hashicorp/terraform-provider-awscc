...
func schemaAttribute02d727482cd1a36ed33c6559() schema.Attribute {
...
func schemaAttribute1b7c83cc4a3c24d3042c40ef() schema.Attribute {
	return (schema.StringAttribute{ /*START ATTRIBUTE*/
...
func schemaAttribute51231a649658c94f8df41266() schema.Attribute {
	return (schema.ListNestedAttribute{ /*START ATTRIBUTE*/
		NestedObject: schema.NestedAttributeObject{ /*START NESTED OBJECT*/
			Attributes: map[string]schema.Attribute{ /*START SCHEMA*/
				// Property: Key
				"key": schemaAttribute02d727482cd1a36ed33c6559(),
				// Property: Value
				"value": schemaAttribute1b7c83cc4a3c24d3042c40ef(),
			}, /*END SCHEMA*/
		}, /*END NESTED OBJECT*/
...
func schemaAttribute69711f5badf0374c391687a1() schema.Attribute {
	return (schema.StringAttribute{ /*START ATTRIBUTE*/
...
func schemaAttributea11ad4cea7decc19661eacef() schema.Attribute {
	return (schema.StringAttribute{ /*START ATTRIBUTE*/
...
func schemaAttributed98f80fec4b0feaf5b038abd() schema.Attribute {
	return (schema.StringAttribute{ /*START ATTRIBUTE*/
...
func schemaAttributeefd6b9e59f2e295c22e2e4a1() schema.Attribute {
	return (schema.StringAttribute{ /*START ATTRIBUTE*/
...
func dBClusterParameterGroupDataSource(ctx context.Context) (datasource.DataSource, error) {
	attributes := map[string]schema.Attribute{ /*START SCHEMA*/
		...
		//	  "type": "string"
		//	}
		"db_cluster_parameter_group_name": schemaAttribute69711f5badf0374c391687a1(),
		...
		//	  "type": "string"
		//	}
		"description": schemaAttributea11ad4cea7decc19661eacef(),
		// Property: Family
		// CloudFormation resource type schema:
		//
		//	{
		...
		//	  "type": "string"
		//	}
		"family": schemaAttributed98f80fec4b0feaf5b038abd(),
		// Property: Parameters
		// CloudFormation resource type schema:
		//
		//	{
		...
		//	  "type": "object"
		//	}
		"parameters": schemaAttributeefd6b9e59f2e295c22e2e4a1(),
		// Property: Tags
		// CloudFormation resource type schema:
		//
		//	{
		...
		//	  "type": "array"
		//	}
		"tags": schemaAttribute51231a649658c94f8df41266(),
	} /*END SCHEMA*/
