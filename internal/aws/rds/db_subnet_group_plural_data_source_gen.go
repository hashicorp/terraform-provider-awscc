...
func init() {
	registry.AddDataSourceFactory("awscc_rds_db_subnet_groups", dBSubnetGroupsDataSource)
}

// dBSubnetGroupsDataSource returns the Terraform awscc_rds_db_subnet_groups data source.
