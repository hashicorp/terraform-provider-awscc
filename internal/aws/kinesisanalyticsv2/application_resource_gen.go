...
func init() {
	registry.AddResourceTypeFactory("awscc_kinesisanalyticsv2_application", applicationResourceType)
}

// applicationResourceType returns the Terraform awscc_kinesisanalyticsv2_application resource type.
// This Terraform resource type corresponds to the CloudFormation AWS::KinesisAnalyticsV2::Application resource type.
			...
			Attributes: tfsdk.SingleNestedAttributes(
				map[string]tfsdk.Attribute{
					"application_maintenance_window_start_time": {
						...
						Required:    true,
						Validators: []tfsdk.AttributeValidator{
							validate.StringMatch(regexp.MustCompile("^([01][0-9]|2[0-3]):[0-5][0-9]$"), ""),
						},
					},
				},
			),
