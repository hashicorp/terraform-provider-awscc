...
func init() {
	registry.AddDataSourceTypeFactory("awscc_kinesisanalyticsv2_application", applicationDataSourceType)
}

// applicationDataSourceType returns the Terraform awscc_kinesisanalyticsv2_application data source type.
