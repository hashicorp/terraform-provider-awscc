...
func init() {
	registry.AddDataSourceFactory("awscc_codeartifact_domains", domainsDataSource)
}

// domainsDataSource returns the Terraform awscc_codeartifact_domains data source.
