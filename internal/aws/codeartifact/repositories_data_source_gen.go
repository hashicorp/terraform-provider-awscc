...
func repositoriesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::CodeArtifact::Repository", "awscc_codeartifact_repositories", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_codeartifact_repositories", "schema", hclog.Fmt("%v", schema))
