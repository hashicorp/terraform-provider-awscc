...
func TestAccAWSDLMLifecyclePolicyDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::DLM::LifecyclePolicy", "awscc_dlm_lifecycle_policy", "test")
...
func TestAccAWSDLMLifecyclePolicyDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::DLM::LifecyclePolicy", "awscc_dlm_lifecycle_policy", "test")
