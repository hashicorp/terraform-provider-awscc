...
func TestAccAWSWellArchitectedLensDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::WellArchitected::Lens", "awscc_wellarchitected_lens", "test")
...
func TestAccAWSWellArchitectedLensDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::WellArchitected::Lens", "awscc_wellarchitected_lens", "test")
