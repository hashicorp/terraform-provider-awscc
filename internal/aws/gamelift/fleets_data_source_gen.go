...
func init() {
	registry.AddDataSourceTypeFactory("awscc_gamelift_fleets", fleetsDataSourceType)
}
...
func fleetsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_gamelift_fleets", "schema", hclog.Fmt("%v", schema))
