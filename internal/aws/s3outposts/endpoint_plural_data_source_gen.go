...
func init() {
	registry.AddDataSourceFactory("awscc_s3outposts_endpoints", endpointsDataSource)
}

// endpointsDataSource returns the Terraform awscc_s3outposts_endpoints data source.
