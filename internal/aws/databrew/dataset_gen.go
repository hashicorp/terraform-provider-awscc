...
func init() {
	registry.AddResourceTypeFactory("aws_databrew_dataset", dataset)
}

// dataset returns the Terraform aws_databrew_dataset resource type.
// This Terraform resource type corresponds to the CloudFormation AWS::DataBrew::Dataset resource type.
func dataset(ctx context.Context) (tfsdk.ResourceType, error) {
