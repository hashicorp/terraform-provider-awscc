...
func init() {
	registry.AddDataSourceFactory("awscc_appsync_apis", apisDataSource)
}

// apisDataSource returns the Terraform awscc_appsync_apis data source.
...
func apisDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::AppSync::Api").WithTerraformTypeName("awscc_appsync_apis")
