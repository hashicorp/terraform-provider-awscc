...
func TestAccAWSRoute53ResolverFirewallDomainListDataSource_basic(t *testing.T) {
...
func TestAccAWSRoute53ResolverFirewallDomainListDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Route53Resolver::FirewallDomainList", "awscc_route53resolver_firewall_domain_list", "test")
