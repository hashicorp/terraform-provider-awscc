...
func init() {
	registry.AddDataSourceFactory("awscc_route53resolver_resolver_rules", resolverRulesDataSource)
}

// resolverRulesDataSource returns the Terraform awscc_route53resolver_resolver_rules data source.
