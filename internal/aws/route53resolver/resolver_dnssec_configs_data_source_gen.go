...
func init() {
	registry.AddDataSourceTypeFactory("awscc_route53resolver_resolver_dnssec_configs", resolverDNSSECConfigsDataSourceType)
}
...
func resolverDNSSECConfigsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_route53resolver_resolver_dnssec_configs", "schema", hclog.Fmt("%v", schema))
