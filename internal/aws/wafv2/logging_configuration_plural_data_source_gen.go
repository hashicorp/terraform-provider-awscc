...
func init() {
	registry.AddDataSourceFactory("awscc_wafv2_logging_configurations", loggingConfigurationsDataSource)
}

// loggingConfigurationsDataSource returns the Terraform awscc_wafv2_logging_configurations data source.
