...
func TestAccAWSDMSCertificateDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::DMS::Certificate", "awscc_dms_certificate", "test")
...
func TestAccAWSDMSCertificateDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::DMS::Certificate", "awscc_dms_certificate", "test")
