...
func init() {
	registry.AddDataSourceTypeFactory("awscc_rum_app_monitors", appMonitorsDataSourceType)
}

// appMonitorsDataSourceType returns the Terraform awscc_rum_app_monitors data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::RUM::AppMonitor resource type.
func appMonitorsDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
