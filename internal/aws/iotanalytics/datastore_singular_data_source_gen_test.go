...
func TestAccAWSIoTAnalyticsDatastoreDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IoTAnalytics::Datastore", "awscc_iotanalytics_datastore", "test")
...
func TestAccAWSIoTAnalyticsDatastoreDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IoTAnalytics::Datastore", "awscc_iotanalytics_datastore", "test")
