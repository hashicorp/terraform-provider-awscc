...
func init() {
	registry.AddDataSourceFactory("awscc_config_aggregation_authorizations", aggregationAuthorizationsDataSource)
}

// aggregationAuthorizationsDataSource returns the Terraform awscc_config_aggregation_authorizations data source.
// This Terraform data source corresponds to the CloudFormation AWS::Config::AggregationAuthorization resource.
func aggregationAuthorizationsDataSource(ctx context.Context) (datasource.DataSource, error) {
