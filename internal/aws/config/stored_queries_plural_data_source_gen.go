...
func init() {
	registry.AddDataSourceTypeFactory("awscc_config_stored_queries", storedQueriesDataSourceType)
}
...
func storedQueriesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_config_stored_queries", "schema", hclog.Fmt("%v", schema))
