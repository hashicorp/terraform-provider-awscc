...
func TestAccAWSConfigConfigurationAggregatorDataSource_basic(t *testing.T) {
...
func TestAccAWSConfigConfigurationAggregatorDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Config::ConfigurationAggregator", "awscc_config_configuration_aggregator", "test")
