...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iot_topic_rules", topicRulesDataSourceType)
}
...
func topicRulesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_iot_topic_rules", "schema", hclog.Fmt("%v", schema))
