...
func domainConfigurationsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::IoT::DomainConfiguration", "awscc_iot_domain_configurations", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_iot_domain_configurations", "schema", hclog.Fmt("%v", schema))
