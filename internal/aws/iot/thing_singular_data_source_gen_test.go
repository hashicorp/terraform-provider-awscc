...
func TestAccAWSIoTThingDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IoT::Thing", "awscc_iot_thing", "test")
...
func TestAccAWSIoTThingDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IoT::Thing", "awscc_iot_thing", "test")
