...
func init() {
	registry.AddDataSourceFactory("awscc_iot_ca_certificates", cACertificatesDataSource)
}

// cACertificatesDataSource returns the Terraform awscc_iot_ca_certificates data source.
// This Terraform data source corresponds to the CloudFormation AWS::IoT::CACertificate resource.
func cACertificatesDataSource(ctx context.Context) (datasource.DataSource, error) {
