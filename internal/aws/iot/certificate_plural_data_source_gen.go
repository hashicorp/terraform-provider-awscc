...
func init() {
	registry.AddDataSourceFactory("awscc_iot_certificates", certificatesDataSource)
}

// certificatesDataSource returns the Terraform awscc_iot_certificates data source.
