...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iot_security_profiles", securityProfilesDataSourceType)
}
...
func securityProfilesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_iot_security_profiles", "schema", hclog.Fmt("%v", schema))
