...
func init() {
	registry.AddDataSourceTypeFactory("awscc_servicecatalog_service_actions", serviceActionsDataSourceType)
}
...
func serviceActionsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_servicecatalog_service_actions", "schema", hclog.Fmt("%v", schema))
