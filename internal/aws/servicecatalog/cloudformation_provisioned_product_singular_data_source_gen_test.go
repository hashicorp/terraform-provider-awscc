...
func TestAccAWSServiceCatalogCloudFormationProvisionedProductDataSource_basic(t *testing.T) {
...
func TestAccAWSServiceCatalogCloudFormationProvisionedProductDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::ServiceCatalog::CloudFormationProvisionedProduct", "awscc_servicecatalog_cloudformation_provisioned_product", "test")
