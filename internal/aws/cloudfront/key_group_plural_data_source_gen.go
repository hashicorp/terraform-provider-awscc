...
func init() {
	registry.AddDataSourceFactory("awscc_cloudfront_key_groups", keyGroupsDataSource)
}

// keyGroupsDataSource returns the Terraform awscc_cloudfront_key_groups data source.
// This Terraform data source corresponds to the CloudFormation AWS::CloudFront::KeyGroup resource.
func keyGroupsDataSource(ctx context.Context) (datasource.DataSource, error) {
