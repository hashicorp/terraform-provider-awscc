...
func init() {
	registry.AddDataSourceFactory("awscc_cloudfront_cloudfront_origin_access_identities", cloudFrontOriginAccessIdentitiesDataSource)
}

// cloudFrontOriginAccessIdentitiesDataSource returns the Terraform awscc_cloudfront_cloudfront_origin_access_identities data source.
// This Terraform data source corresponds to the CloudFormation AWS::CloudFront::CloudFrontOriginAccessIdentity resource.
func cloudFrontOriginAccessIdentitiesDataSource(ctx context.Context) (datasource.DataSource, error) {
