...
func init() {
	registry.AddDataSourceTypeFactory("awscc_cloudfront_cloudfront_origin_access_identities", cloudFrontOriginAccessIdentitiesDataSourceType)
}
...
func cloudFrontOriginAccessIdentitiesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_cloudfront_cloudfront_origin_access_identities", "schema", hclog.Fmt("%v", schema))
