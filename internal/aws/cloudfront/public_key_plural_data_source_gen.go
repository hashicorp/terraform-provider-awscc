...
func init() {
	registry.AddDataSourceFactory("awscc_cloudfront_public_keys", publicKeysDataSource)
}

// publicKeysDataSource returns the Terraform awscc_cloudfront_public_keys data source.
