...
func TestAccAWSMediaPackageV2ChannelGroupDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::MediaPackageV2::ChannelGroup", "awscc_mediapackagev2_channel_group", "test")
...
func TestAccAWSMediaPackageV2ChannelGroupDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::MediaPackageV2::ChannelGroup", "awscc_mediapackagev2_channel_group", "test")
