...
// originEndpointDataSource returns the Terraform awscc_mediapackagev2_origin_endpoint data source.
// This Terraform data source corresponds to the CloudFormation AWS::MediaPackageV2::OriginEndpoint resource.
