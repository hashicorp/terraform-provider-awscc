...
func init() {
	registry.AddDataSourceTypeFactory("awscc_personalize_dataset_groups", datasetGroupsDataSourceType)
}

// datasetGroupsDataSourceType returns the Terraform awscc_personalize_dataset_groups data source type.
