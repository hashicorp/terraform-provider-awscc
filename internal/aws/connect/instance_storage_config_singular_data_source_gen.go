...
func init() {
	registry.AddDataSourceTypeFactory("awscc_connect_instance_storage_config", instanceStorageConfigDataSourceType)
}

// instanceStorageConfigDataSourceType returns the Terraform awscc_connect_instance_storage_config data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::Connect::InstanceStorageConfig resource type.
func instanceStorageConfigDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
