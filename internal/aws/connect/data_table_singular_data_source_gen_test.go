...
func TestAccAWSConnectDataTableDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Connect::DataTable", "awscc_connect_data_table", "test")
...
func TestAccAWSConnectDataTableDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Connect::DataTable", "awscc_connect_data_table", "test")
