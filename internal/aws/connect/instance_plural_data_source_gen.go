...
func init() {
	registry.AddDataSourceFactory("awscc_connect_instances", instancesDataSource)
}

// instancesDataSource returns the Terraform awscc_connect_instances data source.
...
func instancesDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::Connect::Instance").WithTerraformTypeName("awscc_connect_instances")
