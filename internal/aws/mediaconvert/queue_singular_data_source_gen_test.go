...
func TestAccAWSMediaConvertQueueDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::MediaConvert::Queue", "awscc_mediaconvert_queue", "test")
...
func TestAccAWSMediaConvertQueueDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::MediaConvert::Queue", "awscc_mediaconvert_queue", "test")
