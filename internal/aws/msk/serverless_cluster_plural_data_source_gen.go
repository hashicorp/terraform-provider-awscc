...
func init() {
	registry.AddDataSourceFactory("awscc_msk_serverless_clusters", serverlessClustersDataSource)
}

// serverlessClustersDataSource returns the Terraform awscc_msk_serverless_clusters data source.
// This Terraform data source corresponds to the CloudFormation AWS::MSK::ServerlessCluster resource.
func serverlessClustersDataSource(ctx context.Context) (datasource.DataSource, error) {
