...
func originEndpointsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::MediaPackage::OriginEndpoint", "awscc_mediapackage_origin_endpoints", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_mediapackage_origin_endpoints", "schema", hclog.Fmt("%v", schema))
