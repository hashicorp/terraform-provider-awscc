...
func init() {
	registry.AddDataSourceTypeFactory("awscc_networkmanager_site_to_site_vpn_attachment", siteToSiteVpnAttachmentDataSourceType)
}

// siteToSiteVpnAttachmentDataSourceType returns the Terraform awscc_networkmanager_site_to_site_vpn_attachment data source type.
...
func siteToSiteVpnAttachmentDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
