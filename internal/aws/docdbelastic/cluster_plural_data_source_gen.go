...
func init() {
	registry.AddDataSourceFactory("awscc_docdbelastic_clusters", clustersDataSource)
}

// clustersDataSource returns the Terraform awscc_docdbelastic_clusters data source.
...
func clustersDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::DocDBElastic::Cluster").WithTerraformTypeName("awscc_docdbelastic_clusters")
