...
func init() {
	registry.AddDataSourceFactory("awscc_accessanalyzer_analyzer", analyzerDataSourceType)
}
...
func analyzerDataSourceType(ctx context.Context) (datasource.DataSource, error) {
