...
func init() {
	registry.AddDataSourceTypeFactory("awscc_lightsail_database", databaseDataSourceType)
}

// databaseDataSourceType returns the Terraform awscc_lightsail_database data source type.
