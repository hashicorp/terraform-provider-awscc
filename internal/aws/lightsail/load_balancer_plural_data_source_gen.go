...
func init() {
	registry.AddDataSourceFactory("awscc_lightsail_load_balancers", loadBalancersDataSource)
}

// loadBalancersDataSource returns the Terraform awscc_lightsail_load_balancers data source.
