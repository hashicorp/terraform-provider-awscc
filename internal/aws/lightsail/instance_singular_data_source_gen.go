...
func init() {
	registry.AddDataSourceTypeFactory("awscc_lightsail_instance", instanceDataSourceType)
}

// instanceDataSourceType returns the Terraform awscc_lightsail_instance data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::Lightsail::Instance resource type.
func instanceDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
