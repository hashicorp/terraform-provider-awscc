...
func init() {
	registry.AddResourceTypeFactory("aws_applicationinsights_application", application)
}

// application returns the Terraform aws_applicationinsights_application resource type.
