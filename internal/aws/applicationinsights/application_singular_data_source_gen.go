...
func init() {
	registry.AddDataSourceTypeFactory("awscc_applicationinsights_application", applicationDataSourceType)
}

// applicationDataSourceType returns the Terraform awscc_applicationinsights_application data source type.
