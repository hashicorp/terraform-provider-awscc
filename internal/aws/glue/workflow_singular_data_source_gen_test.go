...
func TestAccAWSGlueWorkflowDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Glue::Workflow", "awscc_glue_workflow", "test")
...
func TestAccAWSGlueWorkflowDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Glue::Workflow", "awscc_glue_workflow", "test")
