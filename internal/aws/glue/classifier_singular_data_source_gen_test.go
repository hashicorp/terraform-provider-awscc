...
func TestAccAWSGlueClassifierDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Glue::Classifier", "awscc_glue_classifier", "test")
...
func TestAccAWSGlueClassifierDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Glue::Classifier", "awscc_glue_classifier", "test")
