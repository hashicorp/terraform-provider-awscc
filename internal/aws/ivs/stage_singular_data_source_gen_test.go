...
func TestAccAWSIVSStageDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IVS::Stage", "awscc_ivs_stage", "test")
...
func TestAccAWSIVSStageDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IVS::Stage", "awscc_ivs_stage", "test")
