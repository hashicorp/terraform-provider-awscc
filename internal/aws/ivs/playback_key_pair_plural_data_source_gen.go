...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ivs_playback_key_pairs", playbackKeyPairsDataSourceType)
}
...
func playbackKeyPairsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ivs_playback_key_pairs", "schema", hclog.Fmt("%v", schema))
