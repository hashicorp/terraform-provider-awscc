...
// playbackRestrictionPolicyDataSource returns the Terraform awscc_ivs_playback_restriction_policy data source.
// This Terraform data source corresponds to the CloudFormation AWS::IVS::PlaybackRestrictionPolicy resource.
func playbackRestrictionPolicyDataSource(ctx context.Context) (datasource.DataSource, error) {
