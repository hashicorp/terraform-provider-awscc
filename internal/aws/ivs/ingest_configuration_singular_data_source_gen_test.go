...
func TestAccAWSIVSIngestConfigurationDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IVS::IngestConfiguration", "awscc_ivs_ingest_configuration", "test")
...
func TestAccAWSIVSIngestConfigurationDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::IVS::IngestConfiguration", "awscc_ivs_ingest_configuration", "test")
