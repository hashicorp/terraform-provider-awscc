...
func init() {
	registry.AddDataSourceFactory("awscc_ivs_recording_configurations", recordingConfigurationsDataSource)
}

// recordingConfigurationsDataSource returns the Terraform awscc_ivs_recording_configurations data source.
// This Terraform data source corresponds to the CloudFormation AWS::IVS::RecordingConfiguration resource.
func recordingConfigurationsDataSource(ctx context.Context) (datasource.DataSource, error) {
