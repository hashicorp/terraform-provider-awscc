...
func init() {
	registry.AddDataSourceFactory("awscc_finspace_environments", environmentsDataSource)
}

// environmentsDataSource returns the Terraform awscc_finspace_environments data source.
