...
func init() {
	registry.AddDataSourceTypeFactory("awscc_finspace_environments", environmentsDataSourceType)
}
...
func environmentsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_finspace_environments", "schema", hclog.Fmt("%v", schema))
