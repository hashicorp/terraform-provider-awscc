...
func dataflowEndpointGroupsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::GroundStation::DataflowEndpointGroup", "awscc_groundstation_dataflow_endpoint_groups", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_groundstation_dataflow_endpoint_groups", "schema", hclog.Fmt("%v", schema))
