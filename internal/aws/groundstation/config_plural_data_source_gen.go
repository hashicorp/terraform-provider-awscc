...
func configsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::GroundStation::Config", "awscc_groundstation_configs", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_groundstation_configs", "schema", hclog.Fmt("%v", schema))
