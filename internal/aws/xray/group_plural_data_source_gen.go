...
func init() {
	registry.AddDataSourceFactory("awscc_xray_groups", groupsDataSource)
}

// groupsDataSource returns the Terraform awscc_xray_groups data source.
...
func groupsDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::XRay::Group").WithTerraformTypeName("awscc_xray_groups")
