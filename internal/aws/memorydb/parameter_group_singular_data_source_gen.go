...
func init() {
	registry.AddDataSourceTypeFactory("awscc_memorydb_parameter_group", parameterGroupDataSourceType)
}

// parameterGroupDataSourceType returns the Terraform awscc_memorydb_parameter_group data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::MemoryDB::ParameterGroup resource type.
func parameterGroupDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
