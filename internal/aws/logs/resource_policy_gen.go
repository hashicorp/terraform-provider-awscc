...
func init() {
	registry.AddResourceTypeFactory("aws_logs_resource_policy", resourcePolicyResourceType)
}

// resourcePolicyResourceType returns the Terraform aws_logs_resource_policy resource type.
