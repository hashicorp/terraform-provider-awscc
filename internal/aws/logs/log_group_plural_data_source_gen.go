...
func init() {
	registry.AddDataSourceFactory("awscc_logs_log_groups", logGroupsDataSource)
}

// logGroupsDataSource returns the Terraform awscc_logs_log_groups data source.
// This Terraform data source corresponds to the CloudFormation AWS::Logs::LogGroup resource.
func logGroupsDataSource(ctx context.Context) (datasource.DataSource, error) {
