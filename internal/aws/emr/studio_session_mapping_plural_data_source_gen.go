...
func init() {
	registry.AddDataSourceTypeFactory("awscc_emr_studio_session_mappings", studioSessionMappingsDataSourceType)
}
...
func studioSessionMappingsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_emr_studio_session_mappings", "schema", hclog.Fmt("%v", schema))
