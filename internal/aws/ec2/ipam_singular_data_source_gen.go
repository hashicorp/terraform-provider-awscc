...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ec2_ipam", iPAMDataSourceType)
}

// iPAMDataSourceType returns the Terraform awscc_ec2_ipam data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::EC2::IPAM resource type.
func iPAMDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
