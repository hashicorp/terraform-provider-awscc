...
func init() {
	registry.AddDataSourceFactory("awscc_ec2_dhcp_options_plural", dHCPOptionsPluralDataSource)
}

// dHCPOptionsPluralDataSource returns the Terraform awscc_ec2_dhcp_options_plural data source.
// This Terraform data source corresponds to the CloudFormation AWS::EC2::DHCPOptions resource.
func dHCPOptionsPluralDataSource(ctx context.Context) (datasource.DataSource, error) {
