...
func TestAccAWSEC2LocalGatewayRouteDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::LocalGatewayRoute", "awscc_ec2_local_gateway_route", "test")
...
func TestAccAWSEC2LocalGatewayRouteDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::LocalGatewayRoute", "awscc_ec2_local_gateway_route", "test")
