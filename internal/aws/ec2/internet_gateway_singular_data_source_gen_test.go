...
func TestAccAWSEC2InternetGatewayDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::InternetGateway", "awscc_ec2_internet_gateway", "test")
...
func TestAccAWSEC2InternetGatewayDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::InternetGateway", "awscc_ec2_internet_gateway", "test")
