...
func TestAccAWSEC2VPCEndpointServiceDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::VPCEndpointService", "awscc_ec2_vpc_endpoint_service", "test")
...
func TestAccAWSEC2VPCEndpointServiceDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::VPCEndpointService", "awscc_ec2_vpc_endpoint_service", "test")
