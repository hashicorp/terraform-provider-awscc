...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ec2_egress_only_internet_gateways", egressOnlyInternetGatewaysDataSourceType)
}
...
func egressOnlyInternetGatewaysDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ec2_egress_only_internet_gateways", "schema", hclog.Fmt("%v", schema))
