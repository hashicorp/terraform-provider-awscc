...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ec2_carrier_gateways", carrierGatewaysDataSourceType)
}
...
func carrierGatewaysDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ec2_carrier_gateways", "schema", hclog.Fmt("%v", schema))
