...
func TestAccAWSEC2TrafficMirrorTargetDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::TrafficMirrorTarget", "awscc_ec2_traffic_mirror_target", "test")
...
func TestAccAWSEC2TrafficMirrorTargetDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::TrafficMirrorTarget", "awscc_ec2_traffic_mirror_target", "test")
