...
func TestAccAWSEC2IPv4PoolDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::IPv4Pool", "awscc_ec2_i_pv_4_pool", "test")
...
func TestAccAWSEC2IPv4PoolDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::IPv4Pool", "awscc_ec2_i_pv_4_pool", "test")
