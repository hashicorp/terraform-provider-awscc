...
func TestAccAWSEC2IPAMDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::IPAM", "awscc_ec2_ipam", "test")
...
func TestAccAWSEC2IPAMDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::IPAM", "awscc_ec2_ipam", "test")
