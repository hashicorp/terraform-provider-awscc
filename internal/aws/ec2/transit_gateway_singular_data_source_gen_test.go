...
func TestAccAWSEC2TransitGatewayDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::TransitGateway", "awscc_ec2_transit_gateway", "test")
...
func TestAccAWSEC2TransitGatewayDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::TransitGateway", "awscc_ec2_transit_gateway", "test")
