...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ec2_network_interfaces", networkInterfacesDataSourceType)
}

// networkInterfacesDataSourceType returns the Terraform awscc_ec2_network_interfaces data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::EC2::NetworkInterface resource type.
func networkInterfacesDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
