...
func TestAccAWSEC2InstanceEventWindowDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::InstanceEventWindow", "awscc_ec2_instance_event_window", "test")
...
func TestAccAWSEC2InstanceEventWindowDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::InstanceEventWindow", "awscc_ec2_instance_event_window", "test")
