...
func init() {
	registry.AddResourceTypeFactory("awscc_ec2_network_acl_entry", networkAclEntryResourceType)
}

// networkAclEntryResourceType returns the Terraform awscc_ec2_network_acl_entry resource type.
// This Terraform resource type corresponds to the CloudFormation AWS::EC2::NetworkAclEntry resource type.
func networkAclEntryResourceType(ctx context.Context) (tfsdk.ResourceType, error) {
