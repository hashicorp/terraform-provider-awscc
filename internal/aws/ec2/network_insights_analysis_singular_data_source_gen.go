...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ec2_network_insights_analysis", networkInsightsAnalysisDataSourceType)
}

// networkInsightsAnalysisDataSourceType returns the Terraform awscc_ec2_network_insights_analysis data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::EC2::NetworkInsightsAnalysis resource type.
func networkInsightsAnalysisDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
