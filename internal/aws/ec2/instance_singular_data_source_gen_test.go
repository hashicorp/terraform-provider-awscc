...
func TestAccAWSEC2InstanceDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::Instance", "awscc_ec2_instance", "test")
...
func TestAccAWSEC2InstanceDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::Instance", "awscc_ec2_instance", "test")
