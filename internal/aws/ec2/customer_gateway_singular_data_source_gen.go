...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ec2_customer_gateway", customerGatewayDataSourceType)
}

// customerGatewayDataSourceType returns the Terraform awscc_ec2_customer_gateway data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::EC2::CustomerGateway resource type.
func customerGatewayDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
