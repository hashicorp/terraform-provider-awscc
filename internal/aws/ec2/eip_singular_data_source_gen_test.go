...
func TestAccAWSEC2EIPDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::EIP", "awscc_ec2_eip", "test")
...
func TestAccAWSEC2EIPDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::EIP", "awscc_ec2_eip", "test")
