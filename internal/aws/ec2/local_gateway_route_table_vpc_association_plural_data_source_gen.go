...
func init() {
	registry.AddDataSourceFactory("awscc_ec2_local_gateway_route_table_vpc_associations", localGatewayRouteTableVPCAssociationsDataSource)
}

// localGatewayRouteTableVPCAssociationsDataSource returns the Terraform awscc_ec2_local_gateway_route_table_vpc_associations data source.
// This Terraform data source corresponds to the CloudFormation AWS::EC2::LocalGatewayRouteTableVPCAssociation resource.
func localGatewayRouteTableVPCAssociationsDataSource(ctx context.Context) (datasource.DataSource, error) {
