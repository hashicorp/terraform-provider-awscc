...
// transitGatewayRouteTablePropagationDataSource returns the Terraform awscc_ec2_transit_gateway_route_table_propagation data source.
// This Terraform data source corresponds to the CloudFormation AWS::EC2::TransitGatewayRouteTablePropagation resource.
func transitGatewayRouteTablePropagationDataSource(ctx context.Context) (datasource.DataSource, error) {
