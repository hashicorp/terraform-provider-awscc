...
func flowLogsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::EC2::FlowLog", "awscc_ec2_flow_logs", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ec2_flow_logs", "schema", hclog.Fmt("%v", schema))
