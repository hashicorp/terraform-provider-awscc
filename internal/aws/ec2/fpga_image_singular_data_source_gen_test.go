...
func TestAccAWSEC2FpgaImageDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::FpgaImage", "awscc_ec2_fpga_image", "test")
...
func TestAccAWSEC2FpgaImageDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::FpgaImage", "awscc_ec2_fpga_image", "test")
