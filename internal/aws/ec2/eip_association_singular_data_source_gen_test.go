...
func TestAccAWSEC2EIPAssociationDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::EIPAssociation", "awscc_ec2_eip_association", "test")
...
func TestAccAWSEC2EIPAssociationDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::EIPAssociation", "awscc_ec2_eip_association", "test")
