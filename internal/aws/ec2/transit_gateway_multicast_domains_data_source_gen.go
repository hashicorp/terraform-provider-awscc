...
func init() {
	registry.AddDataSourceTypeFactory("awscc_ec2_transit_gateway_multicast_domains", transitGatewayMulticastDomainsDataSourceType)
}
...
func transitGatewayMulticastDomainsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_ec2_transit_gateway_multicast_domains", "schema", hclog.Fmt("%v", schema))
