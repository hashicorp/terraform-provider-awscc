...
func init() {
	registry.AddDataSourceFactory("awscc_ec2_instances", instancesDataSource)
}

// instancesDataSource returns the Terraform awscc_ec2_instances data source.
...
func instancesDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::EC2::Instance").WithTerraformTypeName("awscc_ec2_instances")
