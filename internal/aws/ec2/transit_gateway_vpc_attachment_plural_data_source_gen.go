...
func init() {
	registry.AddDataSourceFactory("awscc_ec2_transit_gateway_vpc_attachments", transitGatewayVpcAttachmentsDataSource)
}

// transitGatewayVpcAttachmentsDataSource returns the Terraform awscc_ec2_transit_gateway_vpc_attachments data source.
// This Terraform data source corresponds to the CloudFormation AWS::EC2::TransitGatewayVpcAttachment resource.
func transitGatewayVpcAttachmentsDataSource(ctx context.Context) (datasource.DataSource, error) {
