...
func TestAccAWSEC2TrafficMirrorFilterDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::TrafficMirrorFilter", "awscc_ec2_traffic_mirror_filter", "test")
...
func TestAccAWSEC2TrafficMirrorFilterDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::EC2::TrafficMirrorFilter", "awscc_ec2_traffic_mirror_filter", "test")
