...
func init() {
	registry.AddDataSourceTypeFactory("awscc_imagebuilder_image_recipes", imageRecipesDataSourceType)
}
...
func imageRecipesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_imagebuilder_image_recipes", "schema", hclog.Fmt("%v", schema))
