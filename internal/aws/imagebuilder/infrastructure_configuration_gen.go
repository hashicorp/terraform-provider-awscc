...
func init() {
	registry.AddResourceTypeFactory("aws_imagebuilder_infrastructure_configuration", infrastructureConfiguration)
}

// infrastructureConfiguration returns the Terraform aws_imagebuilder_infrastructure_configuration resource type.
...
func infrastructureConfiguration(ctx context.Context) (tfsdk.ResourceType, error) {
