...
func init() {
	registry.AddDataSourceTypeFactory("awscc_apigateway_deployment", deploymentDataSourceType)
}

// deploymentDataSourceType returns the Terraform awscc_apigateway_deployment data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::ApiGateway::Deployment resource type.
func deploymentDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
