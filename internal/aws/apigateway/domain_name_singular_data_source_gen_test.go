...
func TestAccAWSApiGatewayDomainNameDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::ApiGateway::DomainName", "awscc_apigateway_domain_name", "test")
...
func TestAccAWSApiGatewayDomainNameDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::ApiGateway::DomainName", "awscc_apigateway_domain_name", "test")
