...
func init() {
	registry.AddDataSourceTypeFactory("awscc_emrserverless_application", applicationDataSourceType)
}

// applicationDataSourceType returns the Terraform awscc_emrserverless_application data source type.
