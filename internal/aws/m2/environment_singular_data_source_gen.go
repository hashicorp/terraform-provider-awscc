...
func init() {
	registry.AddDataSourceTypeFactory("awscc_m2_environment", environmentDataSourceType)
}

// environmentDataSourceType returns the Terraform awscc_m2_environment data source type.
