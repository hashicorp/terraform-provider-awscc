...
func TestAccAWSNeptuneGlobalClusterDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Neptune::GlobalCluster", "awscc_neptune_global_cluster", "test")
...
func TestAccAWSNeptuneGlobalClusterDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Neptune::GlobalCluster", "awscc_neptune_global_cluster", "test")
