...
func init() {
	registry.AddDataSourceTypeFactory("awscc_kinesisfirehose_delivery_stream", deliveryStreamDataSourceType)
}

// deliveryStreamDataSourceType returns the Terraform awscc_kinesisfirehose_delivery_stream data source type.
// This Terraform data source type corresponds to the CloudFormation AWS::KinesisFirehose::DeliveryStream resource type.
func deliveryStreamDataSourceType(ctx context.Context) (provider.DataSourceType, error) {
