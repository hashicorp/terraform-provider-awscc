...
func init() {
	registry.AddDataSourceFactory("awscc_kinesisfirehose_delivery_streams", deliveryStreamsDataSource)
}

// deliveryStreamsDataSource returns the Terraform awscc_kinesisfirehose_delivery_streams data source.
// This Terraform data source corresponds to the CloudFormation AWS::KinesisFirehose::DeliveryStream resource.
func deliveryStreamsDataSource(ctx context.Context) (datasource.DataSource, error) {
