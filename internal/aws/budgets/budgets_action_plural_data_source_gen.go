...
func budgetsActionsDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	opts = opts.FromCloudFormationAndTerraform("AWS::Budgets::BudgetsAction", "awscc_budgets_budgets_actions", schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_budgets_budgets_actions", "schema", hclog.Fmt("%v", schema))
