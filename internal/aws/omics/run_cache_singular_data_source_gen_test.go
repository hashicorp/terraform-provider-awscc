...
func TestAccAWSOmicsRunCacheDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Omics::RunCache", "awscc_omics_run_cache", "test")
...
func TestAccAWSOmicsRunCacheDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Omics::RunCache", "awscc_omics_run_cache", "test")
