...
func TestAccAWSOmicsRunGroupDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Omics::RunGroup", "awscc_omics_run_group", "test")
...
func TestAccAWSOmicsRunGroupDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::Omics::RunGroup", "awscc_omics_run_group", "test")
