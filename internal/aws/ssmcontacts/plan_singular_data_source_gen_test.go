...
func TestAccAWSSSMContactsPlanDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::SSMContacts::Plan", "awscc_ssmcontacts_plan", "test")
...
func TestAccAWSSSMContactsPlanDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::SSMContacts::Plan", "awscc_ssmcontacts_plan", "test")
