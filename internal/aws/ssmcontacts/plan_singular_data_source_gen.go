...
// planDataSource returns the Terraform awscc_ssmcontacts_plan data source.
// This Terraform data source corresponds to the CloudFormation AWS::SSMContacts::Plan resource.
func planDataSource(ctx context.Context) (datasource.DataSource, error) {
