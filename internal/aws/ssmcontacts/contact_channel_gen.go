...
func contactChannelResourceType(ctx context.Context) (tfsdk.ResourceType, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::SSMContacts::ContactChannel").WithTerraformTypeName("aws_ssmcontacts_contact_channel").WithTerraformSchema(schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "aws_ssmcontacts_contact_channel", "schema", hclog.Fmt("%v", schema))
