...
func detectorModelResourceType(ctx context.Context) (tfsdk.ResourceType, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::IoTEvents::DetectorModel").WithTerraformTypeName("aws_iotevents_detector_model").WithTerraformSchema(schema)
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "aws_iotevents_detector_model", "schema", hclog.Fmt("%v", schema))
