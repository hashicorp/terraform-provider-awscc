...
func TestAccAWSServiceDiscoveryServiceDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::ServiceDiscovery::Service", "awscc_servicediscovery_service", "test")
...
func TestAccAWSServiceDiscoveryServiceDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::ServiceDiscovery::Service", "awscc_servicediscovery_service", "test")
