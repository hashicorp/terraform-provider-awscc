...
func init() {
	registry.AddDataSourceFactory("awscc_appconfig_applications", applicationsDataSource)
}

// applicationsDataSource returns the Terraform awscc_appconfig_applications data source.
...
func applicationsDataSource(ctx context.Context) (datasource.DataSource, error) {
	...
	opts = opts.WithCloudFormationTypeName("AWS::AppConfig::Application").WithTerraformTypeName("awscc_appconfig_applications")
