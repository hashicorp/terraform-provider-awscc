...
func init() {
	registry.AddDataSourceTypeFactory("awscc_iotwireless_wireless_devices", wirelessDevicesDataSourceType)
}
...
func wirelessDevicesDataSourceType(ctx context.Context) (tfsdk.DataSourceType, error) {
	...
	tflog.Debug(ctx, "Generated schema", "tfTypeName", "awscc_iotwireless_wireless_devices", "schema", hclog.Fmt("%v", schema))
