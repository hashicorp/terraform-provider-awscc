...
func init() {
	registry.AddDataSourceFactory("awscc_iotwireless_wireless_devices", wirelessDevicesDataSource)
}

// wirelessDevicesDataSource returns the Terraform awscc_iotwireless_wireless_devices data source.
// This Terraform data source corresponds to the CloudFormation AWS::IoTWireless::WirelessDevice resource.
func wirelessDevicesDataSource(ctx context.Context) (datasource.DataSource, error) {
