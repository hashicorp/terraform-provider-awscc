...
func init() {
	registry.AddDataSourceFactory("awscc_iotwireless_service_profiles", serviceProfilesDataSource)
}

// serviceProfilesDataSource returns the Terraform awscc_iotwireless_service_profiles data source.
// This Terraform data source corresponds to the CloudFormation AWS::IoTWireless::ServiceProfile resource.
func serviceProfilesDataSource(ctx context.Context) (datasource.DataSource, error) {
