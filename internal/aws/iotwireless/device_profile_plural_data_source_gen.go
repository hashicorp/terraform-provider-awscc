...
func init() {
	registry.AddDataSourceFactory("awscc_iotwireless_device_profiles", deviceProfilesDataSource)
}

// deviceProfilesDataSource returns the Terraform awscc_iotwireless_device_profiles data source.
// This Terraform data source corresponds to the CloudFormation AWS::IoTWireless::DeviceProfile resource.
func deviceProfilesDataSource(ctx context.Context) (datasource.DataSource, error) {
