...
func init() {
	registry.AddDataSourceFactory("awscc_iotwireless_destinations", destinationsDataSource)
}

// destinationsDataSource returns the Terraform awscc_iotwireless_destinations data source.
