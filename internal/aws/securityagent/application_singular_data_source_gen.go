...
func init() {
	registry.AddDataSourceFactory("awscc_securityagent_application", agentSpaceDataSource)
}

// agentSpaceDataSource returns the Terraform awscc_securityagent_application data source.
