...
func TestAccAWSSESVdmAttributesDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::SES::VdmAttributes", "awscc_ses_vdm_attributes", "test")
...
func TestAccAWSSESVdmAttributesDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::SES::VdmAttributes", "awscc_ses_vdm_attributes", "test")
