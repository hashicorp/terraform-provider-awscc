...
func init() {
	registry.AddDataSourceFactory("awscc_ses_contact_lists", contactListsDataSource)
}

// contactListsDataSource returns the Terraform awscc_ses_contact_lists data source.
// This Terraform data source corresponds to the CloudFormation AWS::SES::ContactList resource.
func contactListsDataSource(ctx context.Context) (datasource.DataSource, error) {
