...
func TestAccAWSSESReceiptRuleSetDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::SES::ReceiptRuleSet", "awscc_ses_receipt_rule_set", "test")
...
func TestAccAWSSESReceiptRuleSetDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::SES::ReceiptRuleSet", "awscc_ses_receipt_rule_set", "test")
