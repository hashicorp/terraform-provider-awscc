...
func TestAccAWSCloudTrailDashboardDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::CloudTrail::Dashboard", "awscc_cloudtrail_dashboard", "test")
...
func TestAccAWSCloudTrailDashboardDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::CloudTrail::Dashboard", "awscc_cloudtrail_dashboard", "test")
