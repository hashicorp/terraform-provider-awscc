...
func TestAccAWSCloudTrailChannelDataSource_basic(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::CloudTrail::Channel", "awscc_cloudtrail_channel", "test")
...
func TestAccAWSCloudTrailChannelDataSource_NonExistent(t *testing.T) {
	td := acctest.NewTestData(t, "AWS::CloudTrail::Channel", "awscc_cloudtrail_channel", "test")
