...
func init() {
	registry.AddDataSourceFactory("awscc_ssm_documents", documentsDataSource)
}

// documentsDataSource returns the Terraform awscc_ssm_documents data source.
// This Terraform data source corresponds to the CloudFormation AWS::SSM::Document resource.
func documentsDataSource(ctx context.Context) (datasource.DataSource, error) {
