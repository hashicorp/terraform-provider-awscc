...
//go:generate go run generators/singular-data-source/main.go -data-source awscc_lambda_function -cfschema ../service/cloudformation/schemas/AWS_Lambda_Function.json -package lambda ../aws/lambda/function_singular_data_source_gen.go ../aws/lambda/function_singular_data_source_gen_test.go
