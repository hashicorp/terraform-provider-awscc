# 1534 CloudFormation resource types schemas are available for use with the Cloud Control API.
...
resource_schema "aws_apigatewayv2_portal_product" {
  cloudformation_type_name = "AWS::ApiGatewayV2::PortalProduct"
}
...
resource_schema "aws_appstream_user" {
  cloudformation_type_name = "AWS::AppStream::User"
}
...
resource_schema "aws_bedrock_session" {
  cloudformation_type_name = "AWS::Bedrock::Session"
}
...
resource_schema "aws_bedrockagentcore_capacity_provider" {
  cloudformation_type_name = "AWS::BedrockAgentCore::CapacityProvider"
}
...
resource_schema "aws_cloudformation_generated_template" {
  cloudformation_type_name = "AWS::CloudFormation::GeneratedTemplate"
}
...
resource_schema "aws_cloudhsm_cluster" {
  cloudformation_type_name = "AWS::CloudHSM::Cluster"
}
...
resource_schema "aws_codebuild_source_credential" {
  cloudformation_type_name = "AWS::CodeBuild::SourceCredential"
}

resource_schema "aws_codecommit_repository" {
  cloudformation_type_name = "AWS::CodeCommit::Repository"
}
...
resource_schema "aws_codeconnections_host" {
  cloudformation_type_name = "AWS::CodeConnections::Host"
}
...
resource_schema "aws_dax_parameter_group" {
  cloudformation_type_name = "AWS::DAX::ParameterGroup"
}
...
resource_schema "aws_dataexchange_data_set" {
  cloudformation_type_name = "AWS::DataExchange::DataSet"
}

resource_schema "aws_dataexchange_event_action" {
  cloudformation_type_name = "AWS::DataExchange::EventAction"
}
...
resource_schema "aws_devicefarm_device_pool" {
  cloudformation_type_name               = "AWS::DeviceFarm::DevicePool"
  suppress_plural_data_source_generation = true
}

resource_schema "aws_devicefarm_instance_profile" {
  cloudformation_type_name = "AWS::DeviceFarm::InstanceProfile"
}

resource_schema "aws_devicefarm_network_profile" {
  cloudformation_type_name               = "AWS::DeviceFarm::NetworkProfile"
  suppress_plural_data_source_generation = true
}

resource_schema "aws_devicefarm_project" {
  cloudformation_type_name = "AWS::DeviceFarm::Project"
}

resource_schema "aws_devicefarm_test_grid_project" {
  cloudformation_type_name = "AWS::DeviceFarm::TestGridProject"
}

resource_schema "aws_devicefarm_upload" {
  cloudformation_type_name               = "AWS::DeviceFarm::Upload"
  suppress_plural_data_source_generation = true
}

resource_schema "aws_devicefarm_vpce_configuration" {
  cloudformation_type_name = "AWS::DeviceFarm::VPCEConfiguration"
}
...
resource_schema "aws_docdb_db_cluster_parameter_group" {
  cloudformation_type_name = "AWS::DocDB::DBClusterParameterGroup"
}
...
resource_schema "aws_docdb_event_subscription" {
  cloudformation_type_name = "AWS::DocDB::EventSubscription"
}
...
resource_schema "aws_ec2_fpga_image" {
  cloudformation_type_name = "AWS::EC2::FpgaImage"
}
...
resource_schema "aws_gameliftstreams_application" {
  cloudformation_type_name = "AWS::GameLiftStreams::Application"
}

resource_schema "aws_gameliftstreams_stream_group" {
  cloudformation_type_name = "AWS::GameLiftStreams::StreamGroup"
}
...
resource_schema "aws_glue_blueprint" {
  cloudformation_type_name = "AWS::Glue::Blueprint"
}
...
resource_schema "aws_glue_classifier" {
  cloudformation_type_name = "AWS::Glue::Classifier"
}
...
resource_schema "aws_glue_custom_entity_type" {
  cloudformation_type_name = "AWS::Glue::CustomEntityType"
}
...
resource_schema "aws_glue_data_quality_ruleset" {
  cloudformation_type_name = "AWS::Glue::DataQualityRuleset"
}
...
resource_schema "aws_glue_security_configuration" {
  cloudformation_type_name = "AWS::Glue::SecurityConfiguration"
}

resource_schema "aws_glue_session" {
  cloudformation_type_name = "AWS::Glue::Session"
}
...
resource_schema "aws_guardduty_custom_detection_rule_association" {
  cloudformation_type_name = "AWS::GuardDuty::CustomDetectionRuleAssociation"
}
...
resource_schema "aws_iot_job" {
  cloudformation_type_name = "AWS::IoT::Job"
}
...
resource_schema "aws_iot_stream" {
  cloudformation_type_name = "AWS::IoT::Stream"
}
...
resource_schema "aws_iotsecuretunneling_tunnel" {
  cloudformation_type_name = "AWS::IoTSecureTunneling::Tunnel"
}
...
resource_schema "aws_lightsail_contact_method" {
  cloudformation_type_name = "AWS::Lightsail::ContactMethod"
}
...
resource_schema "aws_mediatailor_function" {
  cloudformation_type_name = "AWS::MediaTailor::Function"
}
...
resource_schema "aws_omics_run_cache" {
  cloudformation_type_name = "AWS::Omics::RunCache"
}
...
resource_schema "aws_personalize_metric_attribution" {
  cloudformation_type_name = "AWS::Personalize::MetricAttribution"
}
...
resource_schema "aws_quicksight_flow" {
  cloudformation_type_name = "AWS::QuickSight::Flow"
}
...
resource_schema "aws_rds_cluster_snapshot" {
  cloudformation_type_name = "AWS::RDS::ClusterSnapshot"
}
...
resource_schema "aws_rds_db_snapshot" {
  cloudformation_type_name = "AWS::RDS::DBSnapshot"
}
...
resource_schema "aws_sdb_domain" {
  cloudformation_type_name = "AWS::SDB::Domain"
}
...
resource_schema "aws_ssm_cloud_connector" {
  cloudformation_type_name = "AWS::SSM::CloudConnector"
}
...
resource_schema "aws_sagemaker_artifact" {
  cloudformation_type_name = "AWS::SageMaker::Artifact"
}
...
resource_schema "aws_sagemaker_experiment" {
  cloudformation_type_name = "AWS::SageMaker::Experiment"
}
...
resource_schema "aws_sagemaker_human_task_ui" {
  cloudformation_type_name = "AWS::SageMaker::HumanTaskUi"
}
...
resource_schema "aws_sagemaker_trial_component" {
  cloudformation_type_name = "AWS::SageMaker::TrialComponent"
}
...
resource_schema "aws_serverlessrepo_application" {
  cloudformation_type_name = "AWS::ServerlessRepo::Application"
}
...
resource_schema "aws_supportauthz_support_permit" {
  cloudformation_type_name = "AWS::SupportAuthZ::SupportPermit"
}
...
resource_schema "aws_textract_adapter" {
  cloudformation_type_name = "AWS::Textract::Adapter"
}
...
resource_schema "aws_transcribe_vocabulary_filter" {
  cloudformation_type_name = "AWS::Transcribe::VocabularyFilter"
}
...
resource_schema "aws_translate_parallel_data" {
...
resource_schema "aws_wellarchitected_lens" {
  cloudformation_type_name = "AWS::WellArchitected::Lens"
}

resource_schema "aws_wellarchitected_profile" {
  cloudformation_type_name = "AWS::WellArchitected::Profile"
}

resource_schema "aws_wellarchitected_review_template" {
...
resource_schema "aws_workspaces_workspace_ip_group" {
  cloudformation_type_name = "AWS::WorkSpaces::WorkspaceIpGroup"
}
