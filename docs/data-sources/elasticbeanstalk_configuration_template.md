...
page_title: "awscc_elasticbeanstalk_configuration_template Data Source - terraform-provider-awscc"
subcategory: ""
description: |-
  Data Source schema for AWS::ElasticBeanstalk::ConfigurationTemplate
---

# awscc_elasticbeanstalk_configuration_template (Data Source)
