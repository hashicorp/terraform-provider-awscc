...
page_title: "awscc_directconnect_transit_virtual_interface Resource - terraform-provider-awscc"
subcategory: ""
description: |-
  Resource Type definition for AWS::DirectConnect::TransitVirtualInterface
---

# awscc_directconnect_transit_virtual_interface (Resource)
...
```shell
$ terraform import awscc_directconnect_transit_virtual_interface.example "virtual_interface_arn"
```
