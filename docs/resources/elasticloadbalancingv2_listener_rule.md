...
<a id="nestedatt--actions--jwt_validation_config"></a>
### Nested Schema for `actions.jwt_validation_config`

Optional:

- `additional_claims` (Attributes List) (see [below for nested schema](#nestedatt--actions--jwt_validation_config--additional_claims))
- `issuer` (String)
- `jwks_endpoint` (String)

<a id="nestedatt--actions--jwt_validation_config--additional_claims"></a>
### Nested Schema for `actions.jwt_validation_config.additional_claims`
