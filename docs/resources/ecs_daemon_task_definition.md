...
page_title: "awscc_ecs_daemon_task_definition Resource - terraform-provider-awscc"
subcategory: ""
description: |-
...
# awscc_ecs_daemon_task_definition (Resource)
...
```terraform
import {
  to = awscc_ecs_daemon_task_definition.example
  identity = {
