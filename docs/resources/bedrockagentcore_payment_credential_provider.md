...
page_title: "awscc_bedrockagentcore_payment_credential_provider Resource - terraform-provider-awscc"
subcategory: ""
description: |-
  Resource Type definition for AWS::BedrockAgentCore::PaymentCredentialProvider
---

# awscc_bedrockagentcore_payment_credential_provider (Resource)
...
```terraform
import {
  to = awscc_bedrockagentcore_payment_credential_provider.example
  identity = {
