...
### Create a MediaConnect Router Output
Create a MediaConnect router output with network interface configuration and RTP protocol settings for regional video streaming
