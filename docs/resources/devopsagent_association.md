...
```terraform
import {
  to = awscc_devopsagent_association.example
  identity = {
...
import {
  to = awscc_devopsagent_association.example
  id = "agent_space_id|association_id"
}
```
...
```shell
$ terraform import awscc_devopsagent_association.example "agent_space_id|association_id"
```
