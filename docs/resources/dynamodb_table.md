...
- `resource_policy` (Attributes) An AWS resource-based policy document in JSON format that will be attached to the table.
...
```terraform
import {
  to = awscc_dynamodb_table.example
  identity = {
...
- `table_name` (String) A name for the table
