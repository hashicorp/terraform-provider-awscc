...
page_title: "awscc_bedrockagentcore_payment_manager Resource - terraform-provider-awscc"
subcategory: ""
description: |-
  Resource Type definition for AWS::BedrockAgentCore::PaymentManager
---

# awscc_bedrockagentcore_payment_manager (Resource)
...
```shell
$ terraform import awscc_bedrockagentcore_payment_manager.example "payment_manager_arn"
```
