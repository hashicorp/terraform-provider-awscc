...
page_title: "awscc_networkmanager_site_to_site_vpn_attachment Resource - terraform-provider-awscc"
subcategory: ""
description: |-
  AWS::NetworkManager::SiteToSiteVpnAttachment Resource Type definition.
---

# awscc_networkmanager_site_to_site_vpn_attachment (Resource)
...
```shell
$ terraform import awscc_networkmanager_site_to_site_vpn_attachment.example AttachmentId
```
