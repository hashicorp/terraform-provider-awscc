...
download-schemas:
	go run tools/schema-downloader/main.go -config internal/service/cloudformation/schemas-sync/all_schemas.hcl -dest-dir internal/service/cloudformation/schemas-sync
