...
require (
	...
	github.com/hashicorp/terraform-plugin-framework v0.0.0-20210602173129-1ab898feb56e // indirect
	github.com/hashicorp/terraform-plugin-go v0.3.1-0.20210601164646-1df22172e56a // indirect
